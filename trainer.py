        ...
        if np.log(validation_ppl) * min_improvement > np.log(best_validation_ppl): # Mikolovs recipe
            if not divide:
                ...
                if validation_ppl > best_validation_ppl:
                    ...
                    net = utils.load_model("/Users/mayili/Documents/intern/NLP/punctuation/punctuator-master/out/" + model_name)
            else:
                if validation_ppl < best_validation_ppl:
                    print( "\tSaving model.")
                    net.save("/Users/mayili/Documents/intern/NLP/punctuation/punctuator-master/out/" + model_name, final=True)
                break
        else:
            print( "\tNew best model! Saving...")
            best_validation_ppl = validation_ppl
            final = learning_rate / 2. < min_learning_rate or epoch == max_epochs
            net.save("/Users/mayili/Documents/intern/NLP/punctuation/punctuator-master/out/" + model_name, final)
