...
def convert_files(file_paths, vocabulary, punctuations, batch_size, use_pauses, output_path):
    ...
    # final format of converted data ,which is a dictionary
    #inputs includes the word and its index
    #output includes the punctuation and its index
