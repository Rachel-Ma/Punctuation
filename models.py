...
class Model(object):
    ...
    def load(self, model):        
        ...
        self.gate_activation = getattr(activation_functions,
...
class T_LSTM(Model):
    ...
    def initialize(self, hidden_size, projection_size, in_vocabulary, out_vocabulary, batch_size, 
                   hidden_activation="Tanh",gate_activation="Sigmoid", bptt_steps=5, use_pauses=False):
    ...
    def _backpropagate(self, output_word_index):
        ...
        for pauses, words, W, Wr, Wip, Wfp, Wop, x, m_tm1, h_tm1, z, i, ig, fg, og in reversed(list(zipped)):
    ...
    def update(self, _, output_word_index, learning_rate):
        """Uses AdaGrad: Duchi, John, Elad Hazan, and Yoram Singer.
    ...
    def save(self, file_name, final):
        ...
        model = {
            ...
            "gate_activation_name":         self.gate_activation_name,
        }
        for p in self.params:
